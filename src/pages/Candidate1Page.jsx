      ...
      <div className="max-w-2xl mx-auto relative">
        ...
        {/* <div className="mt-4 bg-white/80 backdrop-blur-sm rounded-xl p-4 border-2 border-blue-400 shadow-lg">
          <h3 className="font-bold text-blue-800 mb-2 flex items-center gap-2 text-lg">
            <span className="text-xl">🗳️</span> Voting for Candidate 1
          </h3>
          ...
          {/* <div className="text-center">
            {localVoteDone ? (
              ...
              <button
                ...
                className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-bold rounded-lg shadow-lg hover:from-blue-700 hover:to-purple-700 transition-all transform hover:scale-105 disabled:opacity-50 disabled:cursor-not-allowed"
              >
